...
await build({
  ...
  package: {
    ...
    description: "Universal FTX API client",
    license: "MIT",
    sideEffects: false,
    "publishConfig": {
      "access": "public",
    ...
    repository: {
      type: "git",
      url: "https://github.com/coinset/ftx.git",
    },
    bugs: {
      url: "https://github.com/coinset/ftx/issues",
    },
    homepage: "https://github.com/coinset/ftx#readme",
    funding: {
      type: "patreon",
